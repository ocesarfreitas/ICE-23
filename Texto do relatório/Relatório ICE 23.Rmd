...
Os dados foram coletados por unidade federativa e os municípios de determinada UF receberam um score proporcional à sua posição dentro do ranking da UF.
...
|------------------------------------	|-------- |-------- |-------- |------- |-------	|-------- |
| **Índice de Acesso a Capital**     	| 0.70  	| 0.03  	| -0.05 	| 0.50 	 | 0.504 	| 1.0 	  |
| **Índice de Ambiente Regulatório** 	| 0.34  	| 0.60  	| -0.66  	| 0.92 	 | 0.081 	| 2.5 	  |
| **Índice de Capital Humano**       	| 0.71 	  | -0.07 	| 0.39 	| 0.66 	 | 0.338 	| 1.6 	  |
| **Índice de Cultura**              	| 0.01 	  | 0.83 	| 0.46  	| 0.90 	 | 0.095 	| 1.6 	  |
| **Índice de Infraestrutura**       	| 0.71 	  | -0.28 	| -0.22  	| 0.64 	 | 0.364 	| 1.5 	  |
| **Índice de Inovação**             	| 0.84 	  | -0.09  	| 0.15 	| 0.74 	 | 0.264 	| 1.1 	  |
| **Índice de Mercado**              	| 0.78 	  | 0.12  	| 0.01  	| 0.62 	 | 0.383 	| 1.1 	  |
...
|------------------------------------	|-------- |-------- |-------- |------- |-------	|-------- |
| **Índice de Acesso a Capital**     	| 0.67  	| 0.22  	| -0.04 	| 0.50 	 | 0.504 	| 1.2 	  |
| **Índice de Ambiente Regulatório** 	| 0.12  	| 0.95  	| 0.10  	| 0.92 	 | 0.081 	| 1.1 	  |
| **Índice de Capital Humano**       	| 0.78 	  | -0.18 	| 0.13  	| 0.66 	 | 0.338 	| 1.2 	  |
| **Índice de Cultura**              	| 0.03 	  | 0.12 	| 0.94  	| 0.90 	 | 0.095 	| 1.0 	  |
| **Índice de Infraestrutura**       	| 0.67 	  | 0.18 	  | -0.39  	| 0.64 	 | 0.364 	| 1.8 	  |
| **Índice de Inovação**             	| 0.86 	  | 0.04  	| -0.03 	| 0.74 	 | 0.264 	| 1.0 	  |
| **Índice de Mercado**              	| 0.74 	  | 0.25  	| 0.07  	| 0.62 	 | 0.383 	| 1.2 	  |
...
|                           	| **RC1** 	| **RC2** 	| **RC3** 	|
|---------------------------	|:-------:	|---------	|---------	|
| **SS loadings**           	|   2.81  	| 1.09    	| 1.08    	|
| **Proportion Var**        	|   0.40  	| 0.16    	| 0.15    	|
| **Cumulative Var**        	|   0.40  	| 0.56    	| 0.71    	|
...
|           | **RC1** 	| **RC2** 	| **RC3** 	|
|----------	|:-------:	|---------	|---------	|
| **RC1**   |   0.969   	| -0.049    	| -0.239    	|
| **RC2**   |   -0.098   	| 0.817    	| -0.637    	|
| **RC3**   |   0.224 	| 0.573     	| 0.787    	|
...
| Índice de Ambiente Regulatório 	|   0.69   	|
| Índice de Capital Humano       	|   0.83   	|
| Índice de Cultura              	|   0.39   	|
| Índice de Infraestrutura       	|   0.82   	|
| Índice de Inovação             	|   0.78   	|
| Índice de Mercado              	|   0.81   	|
| **Overall MSA**                	| **0.79** 	|
...
| Índice de Ambiente Regulatório | 0.047920792          | 0.634162037 |
| Índice de Capital Humano       | 0.12446127           | 0.214946123 |
| Índice de Cultura              | 0.203757966          | 0.040978578 |
| Índice de Infraestrutura       | 0.087850903          | 0.382340639 |
| Índice de Inovação             | 0.201106581          | 0.043738143 |
| Índice de Mercado              | 0.022306348          | 0.82477073  |
| Índice Cidades Empreendendoras | 0.376815731          | 0.000102754 |
